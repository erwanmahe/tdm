...
/*
    ...
    Translated by Stephan Uebelhör <su@gateone.biz>
     ------------------------------------------------------------------------------------
...
<?php 
     ...
     $next_picture="Volgende beeld";
     $previous_picture="Vorige beeld";
     $first_picture="Eerste beeld";
     $last_picture="Laatste beeld";
     $index_thumbnail="Overzicht";
     $index_album="Overzicht van alle Album's";
?>