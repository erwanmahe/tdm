...
/*
    ...
    Translated by us (?!) <us@sweet-sorrow.com>
     ------------------------------------------------------------------------------------
...
?>
<?php 
     $next_page="Stranica dalje";
     $previous_page="Stranica nazad";
     $first_page="Prva stranica";
     $last_page="Zadnja stranica";
     $next_picture="Slika dalje";
     $previous_picture="Slika nazad";
     $first_picture="Prva slika";
     $last_picture="Zadnja slika";
     $index_thumbnail="Index";
     $index_album="Album Index";
?>
