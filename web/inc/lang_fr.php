...
<?php 
     ...
     $first_page="Premi&egrave;re page";
     $last_page="Derni&egrave;re page";
     $next_picture="Photo suivante";
     $previous_picture="Photo pr&eacute;c&eacute;dente";
     $first_picture="Premi&egrave;re photo";
     $last_picture="Derni&egrave;re photo";
     $index_thumbnail="Index";
     $index_album="Index des albums";
?>