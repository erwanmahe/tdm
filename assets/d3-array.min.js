...
!(function (t, n) {
      ...
      return (
        u && l
          ? (p(u, c, o, f, i),
            ...
            y(l, o, c, f, i))
          : u
            ? (p(u, o, c, f, i), p(u, c, o, f, i), p(u, o, c, f, i))
            : l && (y(l, o, c, f, i), y(l, c, o, f, i), y(l, o, c, f, i)),
        n
      );
    };
  }
    ...
    if ((r && 2 !== r.length) || n.length > 1) {
      ...
      return (
        n.length > 1
          ...
          : ((r = t.map(r)), e.sort((t, n) => C(r[t], r[n]))),
        L(t, e)
      );
    }
    return t.sort(z(r));
    ...
    function e(e) {
      ...
      if (isFinite(i)) {
        if (i > 0)
          ...
          for (o = 0; o < u; ++o)
            if (null != (f = l[o]) && a <= f && f <= h) {
              const t = Math.floor((a - f) * i);
              v[Math.min(p, t + (d[t] <= f))].push(e[o]);
            }
      } else
        for (o = 0; o < u; ++o)
          null != (f = l[o]) && a <= f && f <= h && v[s(d, f, 0, p)].push(e[o]);
      return v;
    }
    return (
      (e.value = function (n) {
        return arguments.length
          ? ((t = "function" == typeof n ? n : G(n)), e)
          : t;
      }),
      (e.domain = function (t) {
        return arguments.length
          ? ((n = "function" == typeof t ? t : G([t[0], t[1]])), e)
          : n;
      }),
      (e.thresholds = function (t) {
        return arguments.length
          ? ((r =
              "function" == typeof t ? t : G(Array.isArray(t) ? D.call(t) : t)),
            e)
          : r;
      }),
      e
  ...
  function it(t, n, r = f) {
    if (!isNaN((n = +n))) {
      if (((e = Float64Array.from(t, (n, e) => f(r(t[e], e, t)))), n <= 0))
        return nt(e);
      if (n >= 1) return $(e);
      var e,
        ...
        u = Math.floor(i * n);
      return (
        rt(o, u, 0, i, (t, n) => C(e[t], e[n])),
        (u = ot(o.subarray(0, u + 1), (t) => e[t])) >= 0 ? u : -1
      );
    }
  }
  function ut(t, n) {
  ...
  function at(t) {
    ...
    for (var n = -1, r = tt(t, ht), e = new Array(r); ++n < r; )
  ...
  ((t.Adder = N),
    ...
    (t.groupSort = function (t, r, e) {
      return (
        2 !== r.length
          ? P(q(t, r, e), ([t, r], [e, o]) => n(r, o) || n(t, e))
          : P(F(t, e), ([t, e], [o, f]) => r(e, f) || n(t, o))
      ).map(([t]) => t);
    }),
    (t.groups = I),
    (t.histogram = Y),
